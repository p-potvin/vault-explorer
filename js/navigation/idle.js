...
(function () {
    ...
    async function runBatch() {
        ...
        let result = null;
        try {
            // Watchdog: if the batch IPC never resolves (wedged ffmpeg, dead
            // handler), give up after 10 minutes so `running` can't stay true
            // forever and freeze idle generation for the whole session.
